...
{
    /// <summary>
    ///     Process AI of Kingdom Hearts 2
    /// </summary>
    public class AI2
    {
        private readonly SortedDictionary<int, Dis> dict = new SortedDictionary<int, Dis>();
        private readonly SortedDictionary<int, object> errors = new SortedDictionary<int, object>();
        private readonly SortedDictionary<int, String> labels = new SortedDictionary<int, string>();
        private readonly TextWriter wri;
        private BinaryReader br;
        private MemoryStream si;

        public AI2(TextWriter wri)
        {
            this.wri = wri;
        }

        /// <summary>
        ///     Create a little bit more readable file from AI files /!\Should be read as hex later/!\
        /// </summary>
        /// <param name="bin">ai file as an array of bytes</param>
        /// <returns>Little bit more readable file</returns>
        public void Get(byte[] bin)
        {
...

            {
                ...
                si.Position = 0;
                wri.WriteLine("#Parseai modded for OpenKH, based on kkdf2 work");
        ...
        private class Dis
        {
            public readonly String Desc = String.Empty;

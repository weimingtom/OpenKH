        ...
        internal class COMPRESS
        {
            ...
            public static byte[] compress(byte[] input)
            {
                ...
                int i = input.Length,
                    // Input position
                    o = i - 5;
                    // Output position (-5 for the 4 bytes added at the end + 1 byte smaller then input minimum)
            ...
            public static byte[] decompress(byte[] input)
            {
                ...
                checked
                {
                    int ucI = input[(int) (unchecked(Length - 2))] |
                              (input[(int) (unchecked(Length - 3))] | input[(int) (unchecked(Length - 4))] << 8) << 8;

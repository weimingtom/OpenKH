...
namespace khiiMapv.CollTest
{
	public class CollReader
	{
		...
		public void Read(Stream si)
		{
			...
			for (int i = 0; i < num; i++)
			{
				this.alCo1.Add(new Co1(binaryReader));
			}
			si.Position = 32L;
			int num3 = binaryReader.ReadInt32();
			int num4 = binaryReader.ReadInt32();
			si.Position = (long)num3;
			while (si.Position < (long)(num3 + num4))
			{
				this.alCo2.Add(new Co2(binaryReader));
			}
			si.Position = 40L;
			int num5 = binaryReader.ReadInt32();
			int num6 = binaryReader.ReadInt32();
			si.Position = (long)num5;
			while (si.Position < (long)(num5 + num6))
			{
				this.alCo3.Add(new Co3(binaryReader));
			}
			si.Position = 48L;
			int num7 = binaryReader.ReadInt32();
			int num8 = binaryReader.ReadInt32();
			si.Position = (long)num7;
			while (si.Position < (long)(num7 + num8))
			{
			...
			si.Position = (long)num9;
			while (si.Position < (long)(num9 + num10))
			{

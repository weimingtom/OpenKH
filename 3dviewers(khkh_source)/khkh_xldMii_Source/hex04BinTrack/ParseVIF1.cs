...
namespace hex04BinTrack
{
    public class ParseVIF1
    {
        ...
        {
            var output = new MemoryStream(vu1.vumem, true);
            ...
            while (si.Position < si.Length)
            {
                ...
                if (0x60 == (num2 & 0x60))
                {
                    ...
                    bool flag = num7 == 0;
                    var reader2 = new Reader(br, vl, usn);
        ...
        private class Reader
        {
            ...
            private readonly bool usn;
            private readonly int vl;
